...
public class PlayerCamera : MonoBehaviour
{
    ...
    private void UpdateCameraFollow()
    {
        ...
        if (playerModel.IsCooking || playerModel.IsAdministrating || playerModel.IsInTeleportPanel || playerModel.IsInTrashPanel|| playerModel.IsInTutorial || playerModel.IsInResumeDayPanel || playerModel.IsInBankruptPanel) return;
